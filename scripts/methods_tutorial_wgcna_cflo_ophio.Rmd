...
dir.path = "/Users/biplabendudas/Documents/GitHub/deBekker_and_Das_2021"

#' load functions
# customized theme for publication quality figures
source(paste0(dir.path,"/functions/theme_publication.R"))
# function to perform enrichment analysis
source(paste0(dir.path,"/functions/enrichment_analysis.R"))
# function to plot z-scores (Cflo genes only)
source(paste0(dir.path,"/functions/plot_zscores.R"))
